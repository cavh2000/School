...
if(isset($_POST['submit']))
{
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    $myusername = mysqli_real_escape_string($conn,$_POST['rfcp']);
    $mypassword = mysqli_real_escape_string($conn,$_POST['Contraseña']); 
    $mypassword=hash('sha512', $mypassword);
      
    $sql = "select nombreM from maestros where idMae = '$myusername' and contrasenaM = '$mypassword'";
    ...
    if($count == 1) 
    {
      ...
      mysqli_close($conn);
      header("location: maestros_principal.php");
    }
    else
    {
...
?>
 ...
 <div class="form-group">
    ...
    <div>
    <input type="text" class="form-control required"  maxlength="14" name="rfcp" placeholder="Teclee su rfc">
</div>
