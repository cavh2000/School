...
if(!$_POST['terms']){
 ...
 if($_POST['apePat']==""){
  ...
  if($_POST['rfca']==""){
    $errors[]="RFC vacío <br>";
  }if($_POST['rfca']!=trim($_POST['rfca'])){
    $errors[]="RFC no valido <br>";
  }
  
  //Filtro para validar una cadena
  $name=filter_var($_POST['rfca'],
  FILTER_SANITIZE_STRING);
...
if($_POST['Contraseña']==""){
    ...
    require 'conexion.php';
      ...
      $sql="select *from administradores where idAdmin = '$_REQUEST[rfca]';";
...
?>
  ...
  <div class="col-xs-12 col-sm-8 col-md-8">
    <h1><br>Registro de administrador</h1>
  ...
  <form action="registro_de_administradores.php" method="post">
 ...
 <div class="form-group">
    ...
    <div>
    <input type="text" class="form-control required" maxlength="14" name="rfca" placeholder="Teclee su RFC" required>
</div>
