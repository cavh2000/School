<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $errors[]="Favor de llenar los grupos a usar según corresponda <br>";
  }//Filtro para validar que esten llenos


if(!$errors){
    $response['status']="sucess";
    $response['msg']="Registros exitosos";
...
?>
  ...
  <div class="col-xs-12 col-sm-8 col-md-8">
    <h1><br>Registro de grupos</h1>
    <p><br>Sólo se visualizarán los grupos que aún no hayan sido registrados</p>
    <!--Si hay response -->
 ...
 <form action="registro_de_grupos.php" method="post">
  ...
  <?php if(isset($_POST['manana'])): ?>
   ...
   mysqli_close($conn);
  ?>
    <?php if($count == 0 || $count2 == 0 || $count3 == 0 || $count4 == 0 || $count5 == 0 || $count6 == 0): ?>
