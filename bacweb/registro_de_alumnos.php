...
if(!$_POST['terms']){
  ...
  if($_POST['numboleta']==""){
    $errors[]="Boleta vacía <br>";
  }if($_POST['numboleta']!=(filter_var($_POST['numboleta'], FILTER_VALIDATE_INT))){
    $errors[]="Número de boleta no válido <br>";
  }if($_POST['numboleta']!=trim($_POST['numboleta'])){
    $errors[]="Número de boleta no válido <br>";
  }
  //Filtro para validar una cadena
  $name=filter_var($_POST['numboleta'],
  FILTER_SANITIZE_STRING);
  ...
  if($_POST['Contraseña']==""){
    ...
    FILTER_SANITIZE_STRING);
      ...
      $sql="select *from alumnos where idAl = '$_REQUEST[numboleta]';";
...
?>
  ...
  <form action="registro_de_alumnos.php" method="post">
 ...
 <div class="form-group">
    <label for="numboleta" class="control-label">Introduzca su número de boleta</label>
    <div>
    <input type="text" maxlength="10" minlength="10" class="form-control required" name="numboleta" placeholder="Ejemplo: 201*140***" required>
</div>
    <small id="numboletaHelp" class="form-text text-muted"></small>
  </div><!-- Boleta-->
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control required" name="Contraseña" placeholder="Contraseña de Usuario" maxlength="30" required>
  </div><!-- Contraseña-->

  <div class="form-group">
    <div> <label for="Contraseña2"></label></div>
    <input type="password" class="form-control required" name="Contraseña2" placeholder="Confirmar contraseña" maxlength="30" required>
  </div><!-- Contraseña-->
