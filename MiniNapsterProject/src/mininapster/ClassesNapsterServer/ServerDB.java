...
public class ServerDB implements Serializable {
    ...
    public void deleteUser(User user) {
        System.out.println("ServerDB.java, deleteUser method starts!!!");
        connect();
        Statement statement = null;
        try {
            System.out.println(user.getUser());
            statement = connection.createStatement();
            statement.executeUpdate("DELETE FROM tblusers WHERE nick = '" + user.getUser() + "'");
            System.out.println("User deleted successfully: " + user);
        } catch (SQLException e) {
            System.err.println("An error has occurred type: SQLException, in deleteUser method");
            e.printStackTrace();
        } catch (Exception e) {
            System.err.println("An error has occurred type: Exception, in deleteUser method");
            e.printStackTrace();
        } finally {
            try {
                statement.close();
