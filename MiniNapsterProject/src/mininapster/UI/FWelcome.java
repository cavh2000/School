...
import mininapster.ClassesClient.closeSession;
import mininapster.ClassesClient.downloadSong;
import mininapster.ClassesClient.sendSongsData;
import mininapster.ClassesClient.preferencesClient;
...
public class FWelcome extends javax.swing.JFrame implements Serializable, Runnable {
    ...
    private String titles[] = {"File name", "Title", "Artist", "Genere", "Album", "User", "Size (bytes)"};
    ...
    private void initComponents() {
        ...
        LBL_Exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Delete_15px_1.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/napster.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Segoe UI", 3, 48)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("mini napster");
        ...
        LBL_Name.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Musical Notes_15px.png"))); // NOI18N
        ...
        LBL_Artist.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Music Conductor_15px.png"))); // NOI18N
        ...
        LBL_Genere.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/International Music_15px.png"))); // NOI18N
        ...
        LBL_Album.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Music Record_15px.png"))); // NOI18N
    ...
    private void BTN_UpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_UpdateMouseClicked
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Se han cargado las canciones ");
            } catch (Exception ex) {
