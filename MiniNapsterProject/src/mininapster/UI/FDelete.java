...
import mininapster.ClassesClient.SendUserData;
import mininapster.ClassesClient.SendUserDelete;

public class FDelete extends javax.swing.JFrame implements Serializable, Runnable {
    ...
    public void run() {
        try {
            ...
            if(registered && registered != null){
                JOptionPane.showMessageDialog(null, "Usuario borrado '" + user.getUser()+"'");
                new SendUserDelete(user);
    ...
    private void initComponents() {
        ...
        BTN_iniciaSesion.setText("Borrar usuario");
