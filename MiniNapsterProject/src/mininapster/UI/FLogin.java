...
public class FLogin extends javax.swing.JFrame implements Serializable, Runnable {
    ...
    private void initComponents() {
        ...
        PNL_General.setBackground(new java.awt.Color(50, 50, 200));

        PNL_Napster.setBackground(new java.awt.Color(0, 200, 210));

        LBL_iniciaSesion.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        LBL_iniciaSesion.setForeground(new java.awt.Color(51, 51, 51));
        LBL_iniciaSesion.setText("Bienvenido a");

        LBL_LogoNapster.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/napster-100x100.png"))); // NOI18N

        LBL_Napster.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        LBL_Napster.setText("mini-napster");

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Delete_15px_1.png"))); // NOI18N
        ...
        LBL_Usuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Circled User Male_15px_2.png"))); // NOI18N
        ...
        LBL_Contraseña.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mininapster/Images/Password_15px_3.png"))); // NOI18N
        ...
        BTN_iniciaSesion.setBackground(new java.awt.Color(80, 180, 80));
        ...
        LBL_Borrar.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        LBL_Borrar.setForeground(new java.awt.Color(51, 51, 255));
        LBL_Borrar.setText("Click aquí para borrar cuenta");
        LBL_Borrar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                LBL_BorrarMousePressed(evt);
            }
        });
        ...
        PNL_ContentLayout.setHorizontalGroup(
            ...
            .addGroup(PNL_ContentLayout.createSequentialGroup()
                .addGroup(PNL_ContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(TXT_contraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void LBL_BorrarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LBL_RegistrarMousePressed
